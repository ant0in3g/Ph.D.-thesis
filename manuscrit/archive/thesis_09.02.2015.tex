...
\end{eqnarray*}
%
with $u,v \in \Dcal^\prime(\Xsf)$, $f\in\Dcal(\Xsf)$, and $\Psf$ a linear differential operator. The wave front set of the product of two distributions $u, v \in \Dcal^\prime(\Xsf)$ is defined as
%
\begin{equation*}
\WF(u v) \subset \left\{ (x,\xi+\xi^\prime)  \right\} \ . 
\end{equation*}
