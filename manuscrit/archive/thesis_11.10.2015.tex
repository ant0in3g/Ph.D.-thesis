...
%
\begin{enumerate}
\item\label{item:1_pertubative} the elements of this series are plagued by ultraviolet (UV) divergences occurring at very high energy;
%
\item\label{item:2_pertubative} the elements of this series are plagued by infrared (IR) divergences occurring at very low energy;
%
...
%Prima vorrei ringraziare l'università di Genova, e particolarmente il dipartimento di matematica che mi datto l'opportunità e le condizioni per relizare il mio dottorato. Secondo ringrazio il mio relatore di dottorato Nicola Pinamonti. È stato molto paziente e disponibile. Senza la sua aiuta questo lavora non sarebbe possible. Terzo vorrei ringraziare Claudio Dapiaggi per acceptare di essere il controlatore della mia tesi.


%I am grateful to thank my officemate and collaborator Thomas-Paul Hack, whose has been diponible and helpful. I would also like to thank my collaborators Tajron Jurić, Patrizia Vitale, and especially Jean-Christophe Wallet for his help and enthusiasm. I should also thank Pierre Martinetti who without his help i would not have the chance to work with Nicola.


%Furthermore, I would like to thank colleagues and friends who made possible to achieve this project.


%Pour finir je tiens à remercier ma famille, et en particulier mes parents et ma soeur, pour leur soutien tout au longs de ces années. Merci.
...
Before adding more structure on $T_x \Mcal$ we shall introduce the notion of \textbf{vector bundle}. A \textbf{smooth real vector bundle} is a triple $(E,\Mcal,\pi)$, where $E$ (\textbf{total space}) and $\Mcal$ (\textbf{base space} of dimension $n$) are smooth manifolds and 
%
\begin{equation*}
\pi : E \to \Mcal , 
\end{equation*}
