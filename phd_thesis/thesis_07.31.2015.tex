...
\begin{remark}\label{rem:geodesicneighbourhood}
...
\begin{proposition}\label{pr:sigma-1}
...
\begin{proposition}\label{pr:prod-sigma}The operation
...
%
\begin{equation}\label{def:geneuler}
...
\begin{proposition}\label{pr:expose-poles}
...
\begin{proposition}\label{pr:set} Let $\Ncal_n$ be a normal neighbourhood of the total diagonal $d_n$ and suppose that $t\in \Dcal^\prime(\Ncal_n)$ has scaling degree $s_1$ towards $d_n$ under transformations of the form %\eqref{eq:n-dim-scaling} 
...
\begin{lemma}\label{le:rho-over-squared}Let $\Ncal_{x_1}$ be a normal neighbourhood of the point $x_1$ and let $x_2,x_3\in\Ncal_{x_1}$.
Then,  
\[
...
\begin{proposition}\label{pr:almost-homo}
...
\begin{remark}\label{rem:differential}
...
\begin{proposition}\label{pr:propertiesscheme}
...
\begin{remark}\label{rem:missingPPA}
...
\begin{remark}\label{rem:rengroup}
...
\begin{lemma}\label{lem_productidentities}The following distributional identities hold.
\begin{enumerate}
...
\begin{proposition}\label{prop_equivalentscheme}Let $(\Mcal,g)$ be such that $\Mcal$ is a normal neighbourhood and let $\Delta_F$ be a distribution on $\Mcal^2$ of Feynman-Hadamard form %\eqref{eq_DeltaF}. 
