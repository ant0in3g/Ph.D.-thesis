...
\end{itemize}
%
We denote the Lebesgue $\sigma$-algebra on $\mathbb{R}^{n}$ by $L(\Rbb^n)$. A subset $A \subset \Rbb^n$ is contained in $L(\Rbb^n)$ if and only if  
...
\begin{definition}[Lebesgue measure/$\sigma$-algebra]
