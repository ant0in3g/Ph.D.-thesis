...
%\begin{flushright}
%Cultiver un potager, ce n'est pas seulement produire ses légumes,\\ c'est apprendre à s'émerveiller du mystère de la vie. \\[2pt]
%Pierre Rabhi 
%\end{flushright}
...
\addcontentsline{toc}{subsection}{Noncommutative gauge fields}
%----------------------------------------------------------------------------%
...
A_\mu &:=& \nabla_\mu(\Ibb) \ , \quad \mbox{ with } \ A_\mu^\dag = - A_\mu \ , 
\end{eqnarray*}
%
...
\addcontentsline{toc}{subsection}{Classical gauge-invariant action}
%----------------------------------------------------------------------------%
...
\eqref{eq_flog}, and convolution identities, we can finally obtain the Fourier versions of the regularized powers of $\Delta_{\fsf,0}$. For instance, we find for 
%
\begin{eqnarray}
