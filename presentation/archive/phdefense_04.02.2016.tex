...
\newcommand{\sm}[1]{\left\langle #1 \right\rangle} % Define the smearing product.
\newcommand{\abs}[1]{\left|{#1}\right|} % Define the absolute value.
\newcommand{\norm}[1]{\left|{#1}\right|} % Definie the norm.
\renewcommand{\exp}{\mathsf{exp}} % Define the exponential exp.
\renewcommand{\log}{\mathsf{log}} % Define the logarithm.
...
%\includegraphics[scale=1]{./presentation.pdf}
%}
\begin{frame}[plain]
%\titlepage
%
